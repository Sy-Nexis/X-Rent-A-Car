...
export default function DashboardView() {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-8 custom-scrollbar relative flex flex-col gap-6">
      {/* Title section */}
      <div>
      ...
      <button className="absolute bottom-8 right-8 w-12 h-12 rounded-full bg-blue-600 hover:bg-blue-700 active:scale-95 text-white flex items-center justify-center shadow-lg shadow-blue-500/25 transition-all z-20 cursor-pointer">
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
