  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 md:p-8 custom-scrollbar bg-[#0e0e11]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-[#1e1e1e] rounded-2xl border border-white/5 p-6 flex flex-col justify-between shadow-md relative overflow-hidden">
          <div>
            {/* Top row with badge & icon */}
            <div className="flex items-center justify-between mb-6">
              <span className="flex items-center gap-1.5 bg-white/5 border border-white/10 text-brand-cyan text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full">
                <span className="w-1.5 h-1.5 rounded-full bg-brand-cyan animate-pulse" />
                System Active
              </span>
              <div className="w-10 h-10 rounded-xl bg-white/5 text-brand-cyan flex items-center justify-center shadow-md">
            ...
            <h2 className="text-xl font-extrabold uppercase text-white tracking-wider mb-6">
            ...
            <div className="grid grid-cols-2 gap-4 items-center mb-6">
              {/* Stat block */}
              <div className="bg-[#0e0e11] rounded-xl p-5 border border-white/5 shadow-xs h-36 flex flex-col justify-center">
          ...
          <div className="flex justify-between items-center border-t border-white/5 pt-5 mt-2">
            <button className="flex items-center gap-2 bg-brand-gradient hover:opacity-90 text-white text-xs font-extrabold uppercase tracking-wider px-5 py-3 rounded-lg transition-all shadow-md cursor-pointer">
            ...
            <div className="flex items-center -space-x-2">
              <div className="w-7 h-7 rounded-full bg-blue-500 text-white text-[9px] font-bold flex items-center justify-center border-2 border-[#1e1e1e]">A</div>
              <div className="w-7 h-7 rounded-full bg-purple-500 text-white text-[9px] font-bold flex items-center justify-center border-2 border-[#1e1e1e]">B</div>
              <div className="w-7 h-7 rounded-full bg-teal-500 text-white text-[9px] font-bold flex items-center justify-center border-2 border-[#1e1e1e]">C</div>
              <div className="w-7 h-7 rounded-full bg-slate-700 text-white text-[9px] font-extrabold flex items-center justify-center border-2 border-[#1e1e1e]">+5</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#1e1e1e] rounded-2xl border border-white/5 p-6 flex flex-col justify-between shadow-md relative overflow-hidden">
          <div>
            {/* Top row with badge & icon */}
            <div className="flex items-center justify-between mb-6">
              <span className="flex items-center gap-1.5 bg-white/5 border border-white/10 text-brand-green text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full">
                <span className="w-1.5 h-1.5 rounded-full bg-brand-green animate-pulse" />
                Verified Data
              </span>
              <div className="w-10 h-10 rounded-xl bg-white/5 text-brand-green flex items-center justify-center shadow-md">
            ...
            <div className="grid grid-cols-2 gap-4 items-center mb-6">
              ...
              <div className="flex flex-col gap-3 h-36 justify-between">
                {/* Box 1 */}
                <div className="bg-[#0e0e11] text-white rounded-xl p-3 border border-white/5 flex-1 flex flex-col justify-center">
          ...
          {/* Bottom actions row */}
          <div className="flex justify-between items-center border-t border-white/5 pt-5 mt-2">
            <button className="flex items-center gap-2 bg-brand-gradient hover:opacity-90 text-white text-xs font-extrabold uppercase tracking-wider px-5 py-3 rounded-lg transition-all shadow-md cursor-pointer border border-transparent">
              <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {[
          ...
          <div
            key={card.label}
            className="bg-[#1e1e1e] rounded-xl border border-white/5 p-5 flex items-center justify-between shadow-md transition-all cursor-default"
          >
