  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 md:p-8 custom-scrollbar">
      ...
      <div className="flex items-center gap-2 text-[10px] font-bold tracking-wider uppercase text-gray-400 mb-2">
        ...
        <span className="text-blue-500">Add New Client</span>
      </div>

      {/* Page Title */}
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight mb-1">Register New Client</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start mb-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
            <div className="flex items-center justify-between border-b border-gray-100 pb-4 mb-6">
              ...
              <span className="text-[10px] font-extrabold px-2.5 py-1 rounded bg-[#e2e8f0] text-slate-600 uppercase tracking-widest">
                Step 01
              </span>
            </div>
          ...
          <div className="flex justify-between items-center pt-2">
            ...
            <button className="flex items-center gap-2.5 bg-slate-900 hover:bg-slate-800 active:scale-[0.98] text-white text-xs font-extrabold uppercase tracking-wider px-7 py-3 rounded-lg shadow-sm transition-all">
              Register Client
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#111827] text-white rounded-2xl border border-white/5 p-6 shadow-xl relative overflow-hidden">
            {/* Subtle mesh background grid details */}
            <div className="absolute inset-0 opacity-10 bg-[linear-gradient(to_right,#808080_1px,transparent_1px),linear-gradient(to_bottom,#808080_1px,transparent_1px)] bg-[size:14px_24px]" />
            
            <div className="relative z-10">
              <span className="text-cyan-400 text-[10px] uppercase font-extrabold tracking-wider block mb-3">
          ...
          <div className="bg-[#ebf3ff] rounded-2xl border border-[#d3e3fd] p-5 flex items-start gap-4">
            <div className="w-8 h-8 rounded-lg bg-[#d3e3fd] flex items-center justify-center text-[#1c64ec] flex-shrink-0">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <div>
              <h4 className="text-xs font-extrabold text-[#1a56db] uppercase tracking-wider mb-1">
                Data Privacy
              </h4>
              <p className="text-[11px] text-[#2b6cb0] font-medium leading-relaxed">
      ...
      {/* Bottom Metrics Bar */}
      <div className="border-t border-gray-200/80 pt-6 mt-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex flex-col">
            <span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider mb-1">
              Total Active Clients
            </span>
            <span className="text-2xl font-black text-slate-800">1,402</span>
          </div>
          <div className="flex flex-col">
            <span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider mb-1">
              Average Onboarding
            </span>
            <span className="text-2xl font-black text-slate-800">4.2m</span>
          </div>
          <div className="flex flex-col">
            <span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider mb-1">
              System Health
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl font-black text-slate-800">99.9%</span>
              <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse shadow shadow-emerald-400/50" />
            </div>
          </div>
        </div>
      </div>
