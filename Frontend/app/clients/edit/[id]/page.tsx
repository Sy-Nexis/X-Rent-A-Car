      ...
      <div className="flex flex-col lg:flex-row h-screen overflow-hidden">
        ...
        <section className="w-full lg:w-[35%] bg-[#1c1c1e] border-r border-white/5 p-12 lg:p-20 flex flex-col overflow-y-auto custom-scrollbar">
           <div className="flex-1 space-y-12">
              <Link href="/Admin/Client/Details" className="inline-flex items-center gap-3 text-[10px] font-black text-[#6e6e73] hover:text-white uppercase tracking-[0.3em] transition-colors mb-10 group">
